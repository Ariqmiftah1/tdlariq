...
export default function TodoList() {
  ...
  return (
    <div
      style={{
        ...
        padding: '20px',
        borderRadius: '10px',
        background: 'linear-gradient(180deg, #011627, #023E8A)',
        color: '#ffffff',
      ...
      >
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            border: 'none',
            boxShadow: '0 0 10px #00B4D8, 0 0 40px #00B4D8',
  ...
  ? '#d9534f' // Merah lembut untuk deadline habis
  : task.completed
...
return (
  <div
    style={{
      ...
      padding: '20px',
      borderRadius: '10px',
      background: 'linear-gradient(180deg, #1a1a2e, #16213e)', // Latar belakang lebih gelap
      color: '#ffffff',
      boxShadow: '0 8px 20px rgba(0, 0, 0, 0.9)',
      fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif",
    }}
  >
    <h1
      style={{
        ...
        fontWeight: 'bold',
        marginBottom: '20px',
        color: '#00B4D8', // Tetap biru neon untuk elemen penting
      }}
    >
      TO DO LIST
    </h1>
    ...
    >
      <button
        ...
        style={{
          padding: '12px 24px',
          borderRadius: '10px',
          background: 'linear-gradient(90deg, #394867, #212A3E)', // Tombol lebih gelap
          color: '#ffffff',
          fontWeight: 'bold',
          cursor: 'pointer',
          border: 'none',
          boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)', // Shadow lebih halus
          transition: 'transform 0.2s',
        }}
        onMouseEnter={(e) => (e.currentTarget.style.transform = 'scale(1.1)')}
        onMouseLeave={(e) => (e.currentTarget.style.transform = 'scale(1)')}
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  style={{
                    padding: '10px',
                    borderRadius: '5px',
                    background: 'linear-gradient(145deg, #d9534f, #b52a2a)', // Tombol merah lembut
                    color: '#ffffff',
                    border: 'none',
                    cursor: 'pointer',
                    boxShadow: '0 3px 6px rgba(0, 0, 0, 0.4)',
              ...
              <p
                style={{
                  fontSize: '0.8rem',
                  fontWeight: 'bold',
                  color: isExpired ? '#d9534f' : '#8e97f2', // Warna deadline lebih lembut
                }}
              >
